...
```bash
GO111MODULE=on go get -u boltdb/storm
```
...
import (
  "boltdb/storm"
  "boltdb/storm/codec/gob"
  "boltdb/storm/codec/json"
  "boltdb/storm/codec/sereal"
  "boltdb/storm/codec/protobuf"
  "boltdb/storm/codec/msgpack"
)
