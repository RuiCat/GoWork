# purego
[![Go Reference](https://pkg.go.dev/badge/audio/player/purego?GOOS=darwin.svg)](https://pkg.go.dev/audio/player/purego?GOOS=darwin)
...
This example only works on macOS and Linux. For a complete example look at [libc](https://audio/player/purego/tree/main/examples/libc) which supports Windows and FreeBSD.
