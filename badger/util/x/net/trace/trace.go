...
*/
package trace // import "badger/util/x/net/trace"
...
import (
	...
	"badger/util/x/net/internal/timeseries"
)
...
func init() {
	...
	if pat == debugRequestsPath {
		panic("/debug/requests is already registered. You may have two independent copies of " +
			"badger/util/x/net/trace in your binary, trying to maintain separate state. This may " +
...
var contextKey = contextKeyT("badger/util/x/net/trace.Trace")
