...
// The "badger/util/x/protobuf/reflect/protodesc" package converts between
...
// return the protobuf descriptor for the values.
//
// The "badger/util/x/protobuf/types/dynamicpb" package can be used to
...
// The "badger/util/golang/protobuf/proto".MessageReflect function can be used
