...
```
$ go get -u "badger/util/opencensus
```
...
* [net/http](https://godoc.org/"badger/util/opencensus/plugin/ochttp)
* [gRPC](https://godoc.org/"badger/util/opencensus/plugin/ocgrpc)
...
([stats](https://godoc.org/"badger/util/opencensus/stats/view#Exporter),
[trace](https://godoc.org/"badger/util/opencensus/trace#Exporter)):
...
* gRPC integrations use the OpenCensus' [binary propagation format](https://godoc.org/"badger/util/opencensus/trace/propagation).
* HTTP integrations use Zipkin's [B3](https://github.com/openzipkin/b3-propagation)
  ...
  [propagation.HTTPFormat](https://godoc.org/"badger/util/opencensus/trace/propagation#HTTPFormat).
...
[godoc-image]: https://godoc.org/"badger/util/opencensus?status.svg
[godoc-url]: https://godoc.org/"badger/util/opencensus
[gitter-image]: https://badges.gitter.im/census-instrumentation/lobby.svg
[gitter-url]: https://gitter.im/census-instrumentation/lobby?utm_source=badge&utm_medium=badge&utm_campaign=pr-badge&utm_content=badge


[new-ex]: https://godoc.org/"badger/util/opencensus/tag#example-NewMap
[new-replace-ex]: https://godoc.org/"badger/util/opencensus/tag#example-NewMap--Replace

[exporter-prom]: https://godoc.org/contrib."badger/util/opencensus/exporter/prometheus
[exporter-stackdriver]: https://godoc.org/contrib."badger/util/opencensus/exporter/stackdriver
[exporter-zipkin]: https://godoc.org/contrib."badger/util/opencensus/exporter/zipkin
[exporter-jaeger]: https://godoc.org/contrib."badger/util/opencensus/exporter/jaeger
