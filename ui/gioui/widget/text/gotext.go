...
import (
	...
	"ui/util/x/exp/slices"
	"ui/util/x/image/math/fixed"
	"ui/util/x/text/unicode/bidi"

	"ui/util/typesetting/di"
	"ui/util/typesetting/font"
	"ui/util/typesetting/fontscan"
	"ui/util/typesetting/language"
	"ui/util/typesetting/opentype/api"
	"ui/util/typesetting/opentype/api/metadata"
	"ui/util/typesetting/shaping"

	giofont "ui/gioui/font"
	"ui/gioui/font/opentype"
	"ui/gioui/internal/debug"
	"ui/gioui/io/system"
	"ui/gioui/mat/f32"
	"ui/gioui/op"
	"ui/gioui/op/clip"
...
func splitByScript(inputs []shaping.Input, _ di.Direction, buf []shaping.Input) []shaping.Input {
