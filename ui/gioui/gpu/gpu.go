...
import (
	...
	"ui/gioui/gpu/internal/driver"
	"ui/gioui/internal/byteslice"
	"ui/gioui/internal/f32color"
	"ui/gioui/internal/ops"
	"ui/gioui/internal/scene"
	"ui/gioui/internal/stroke"
	"ui/gioui/mat/f32"
	"ui/gioui/op"
	"ui/gioui/op/paint"
	"ui/gioui/widget/layout"
	"ui/util/x/shader"
	"ui/util/x/shader/gio"

	// Register backends.
	_ "ui/gioui/gpu/internal/d3d11"
	_ "ui/gioui/gpu/internal/metal"
	_ "ui/gioui/gpu/internal/opengl"
	_ "ui/gioui/gpu/internal/vulkan"
)
...
func createColorPrograms(b driver.Device, vsSrc shader.Sources, fsSrc [3]shader.Sources, uniforms [4]interface{}) ([4]*pipeline, error) {
	var pipelines [4]*pipeline
	...
	// 3D数据初始化过程
	{
		...
		pipelines[material3D] = &pipeline{pipe, vertBuffer}
	}
	if err != nil {
