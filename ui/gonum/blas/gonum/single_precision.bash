...
| sed -e "s_^\(func (Implementation) \)D\(.*\)\$_$WARNINGF32\1S\2_" \
      ...
      -e 's_^// Id_// Is_' \
      -e 's_"ui/gonum/internal/asm/f64"_"ui/gonum/internal/asm/f32"_' \
      -e 's_"math"_math "ui/gonum/internal/math32"_' \
...
| sed -e "s_^\(func (Implementation) \)Zdot\(.*\)\$_$WARNINGC64\1Cdot\2_" \
      ...
      -e 's_^// Dz_// Sc_' \
      -e 's_"ui/gonum/internal/asm/c128"_"ui/gonum/internal/asm/c64"_' \
      -e 's_"math"_math "ui/gonum/internal/math32"_' \
>> level1cmplx64.go
...
| sed -e "s_^\(func (Implementation) \)Z\(.*\)\$_$WARNINGC64\1C\2_" \
      -e 's_^// Z_// C_' \
      -e 's_"ui/gonum/internal/asm/c128"_"ui/gonum/internal/asm/c64"_' \
      -e 's_"math/cmplx"_cmplx "ui/gonum/internal/cmplx64"_' \
>> level2cmplx64.go
