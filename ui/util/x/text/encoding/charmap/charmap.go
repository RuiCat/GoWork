...
// and Windows 1252.
package charmap // import "ui/util/x/text/encoding/charmap"

import (
	"unicode/utf8"

	"ui/util/x/text/encoding"
	"ui/util/x/text/encoding/internal"
	"ui/util/x/text/encoding/internal/identifier"
	"ui/util/x/text/transform"
)
