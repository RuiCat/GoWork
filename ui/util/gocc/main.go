...
import (
	...
	"ui/util/gocc/internal/config"
	"ui/util/gocc/internal/frontend/parser"
	"ui/util/gocc/internal/frontend/scanner"
	"ui/util/gocc/internal/frontend/token"
	"ui/util/gocc/internal/io"
	genLexer "ui/util/gocc/internal/lexer/gen/golang"
	lexItems "ui/util/gocc/internal/lexer/items"
	"ui/util/gocc/internal/parser/first"
	genParser "ui/util/gocc/internal/parser/gen"
	lr1Action "ui/util/gocc/internal/parser/lr1/action"
	lr1Items "ui/util/gocc/internal/parser/lr1/items"
	"ui/util/gocc/internal/parser/symbols"
	outToken "ui/util/gocc/internal/token"
	genToken "ui/util/gocc/internal/token/gen"
	genUtil "ui/util/gocc/internal/util/gen"
	"ui/util/gocc/internal/util/md"
)
