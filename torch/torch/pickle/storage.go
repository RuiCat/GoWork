...
func (s *HalfStorage) DType() torch.DType {
	return torch.Half
}

func (s *HalfStorage) Device() torch.Device {
	switch s.Location {
	case "cuda":
		return torch.CudaIfAvailable()
	default:
		return torch.CPU
	}
}
...
func (s *BFloat16Storage) DType() torch.DType {
	return torch.BFloat16
}

func (s *BFloat16Storage) Device() torch.Device {
	switch s.Location {
	case "cuda":
		return torch.CudaIfAvailable()
	default:
...
func (s *FloatStorage) DType() torch.DType {
	return torch.Float
}

func (s *FloatStorage) Device() torch.Device {
	switch s.Location {
	case "cuda":
		return torch.CudaIfAvailable()
	default:
...
func (s *DoubleStorage) DType() torch.DType {
	return torch.Double
}

func (s *DoubleStorage) Device() torch.Device {
	switch s.Location {
	case "cuda":
		return torch.CudaIfAvailable()
	default:
...
func (s *CharStorage) DType() torch.DType {
	return torch.Int8
}

func (s *CharStorage) Device() torch.Device {
	switch s.Location {
	case "cuda":
		return torch.CudaIfAvailable()
	default:
...
func (s *ShortStorage) DType() torch.DType {
	return torch.Int16
}

func (s *ShortStorage) Device() torch.Device {
	switch s.Location {
	case "cuda":
		return torch.CudaIfAvailable()
	default:
...
func (s *IntStorage) DType() torch.DType {
	return torch.Int
}

func (s *IntStorage) Device() torch.Device {
	switch s.Location {
	case "cuda":
		return torch.CudaIfAvailable()
	default:
...
func (s *LongStorage) DType() torch.DType {
	return torch.Int64
}

func (s *LongStorage) Device() torch.Device {
	switch s.Location {
	case "cuda":
		return torch.CudaIfAvailable()
	default:
...
func (s *ByteStorage) DType() torch.DType {
	return torch.Uint8
}

func (s *ByteStorage) Device() torch.Device {
	switch s.Location {
	case "cuda":
		return torch.CudaIfAvailable()
	default:
...
func (s *BoolStorage) DType() torch.DType {
	return torch.Float
}

func (s *BoolStorage) Device() torch.Device {
	switch s.Location {
	case "cuda":
		return torch.CudaIfAvailable()
	default:
