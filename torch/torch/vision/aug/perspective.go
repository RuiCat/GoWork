...
func (rp *RandomPerspective) getParams(w, h int64) ([][]int64, [][]int64) {
	...
	tlTs1 := ts.MustRandint(tlVal1, []int64{1}, torch.Int64, torch.CPU)
	tl1 := tlTs1.Int64Values()[0]
	tlTs1.MustDrop()
	tlVal2 := int64(rp.distortionScale*float64(halfH)) + 1
	tlTs2 := ts.MustRandint(tlVal2, []int64{1}, torch.Int64, torch.CPU)
	...
	trTs1 := ts.MustRandintLow(trVal1, w, []int64{1}, torch.Int64, torch.CPU)
	tr1 := trTs1.Int64Values()[0]
	trTs1.MustDrop()
	trVal2 := int64(rp.distortionScale*float64(halfH)) + 1
	trTs2 := ts.MustRandint(trVal2, []int64{1}, torch.Int64, torch.CPU)
	...
	brTs1 := ts.MustRandintLow(brVal1, w, []int64{1}, torch.Int64, torch.CPU)
	br1 := brTs1.Int64Values()[0]
	brTs1.MustDrop()
	brVal2 := h - int64(rp.distortionScale*float64(halfH)) - 1
	brTs2 := ts.MustRandintLow(brVal2, h, []int64{1}, torch.Int64, torch.CPU)
	...
	blTs1 := ts.MustRandint(blVal1, []int64{1}, torch.Int64, torch.CPU)
	bl1 := blTs1.Int64Values()[0]
	blTs1.MustDrop()
	blVal2 := h - int64(rp.distortionScale*float64(halfH)) - 1
	blTs2 := ts.MustRandintLow(blVal2, h, []int64{1}, torch.Int64, torch.CPU)
