...
func (mlm *RobertaForMaskedLM) Load(modelNameOrPath string, config interface{ pretrained.Config }, params map[string]interface{}, device torch.Device) error {
...
//
// This method implements `PretrainedModel` interface.
func (sc *RobertaForSequenceClassification) Load(modelNameOrPath string, config interface{ pretrained.Config }, params map[string]interface{}, device torch.Device) error {
	// var urlOrFilename string
	// // If modelName, infer to default configuration filename:
	// if modelFile, ok := pretrained.RobertaModels[modelNameOrPath]; ok {
	// urlOrFilename = modelFile
...
//
// This method implements `PretrainedModel` interface.
func (mc *RobertaForMultipleChoice) Load(modelNameOrPath string, config interface{ pretrained.Config }, params map[string]interface{}, device torch.Device) error {
	// var urlOrFilename string
	// // If modelName, infer to default configuration filename:
	// if modelFile, ok := pretrained.RobertaModels[modelNameOrPath]; ok {
	// urlOrFilename = modelFile
...
//
// This method implements `PretrainedModel` interface.
func (tc *RobertaForTokenClassification) Load(modelNameOrPath string, config interface{ pretrained.Config }, params map[string]interface{}, device torch.Device) error {
	// var urlOrFilename string
	// // If modelName, infer to default configuration filename:
	// if modelFile, ok := pretrained.RobertaModels[modelNameOrPath]; ok {
	// urlOrFilename = modelFile
...
//
// This method implements `PretrainedModel` interface.
func (qa *RobertaForQuestionAnswering) Load(modelNameOrPath string, config interface{ pretrained.Config }, params map[string]interface{}, device torch.Device) error {
	// var urlOrFilename string
	// // If modelName, infer to default configuration filename:
	// if modelFile, ok := pretrained.RobertaModels[modelNameOrPath]; ok {
	// urlOrFilename = modelFile
